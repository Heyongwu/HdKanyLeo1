...
public class SinatvAdapter extends XRecyclerView.Adapter<XRecyclerView.ViewHolder>{
    ...
    public interface OnItemClickListener{
        public void OnItemClick(View view,int position,String url,String image,String fire,String inckname);
    }
...
//        LiveBean3.DataBeanX.DataBean.OwnerBean ownerBean = list.get(position);
        final LiveBean3.DataBeanX.DataBean.OwnerBean ownerBean = list.get(position).getOwner();
        ...
        if(holder instanceof BnViewHolder){
            ...
            h_sdv_two.setImageURI(ownerBean.getAvatar_large().getUrl_list().get(1));
            h_sdv_three.setImageURI(ownerBean.getAvatar_large().getUrl_list().get(2));
            ...
            lh_sdv_two.setImageURI(ownerBean.getAvatar_large().getUrl_list().get(1));
            lh_sdv_three.setImageURI(ownerBean.getAvatar_large().getUrl_list().get(2));
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(listener!=null){
                    listener.OnItemClick(view,position, url,ownerBean.getAvatar_large().getUrl_list().get(0),ownerBean.getFan_ticket_count()+"",ownerBean.getNickname());
                }
            }
        });
    }
